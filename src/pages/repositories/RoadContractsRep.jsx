...
import { getAllRoadContractsRepo } from "../../redux/features/repositories/roadcontracts-repSlice";

const RoadContractsRepo = () => {
    const dispatch = useDispatch();
    const roadcontractsRepository = useSelector((state) => state.roadcontractsRepo.roadContractsRepository);
    console.log("roadcontractsRepository", roadcontractsRepository);
    const navigate = useNavigate();
    const [page, setPage] = useState(1);
    const [searchTerm, setSearchTerm] = useState("");
    const [totalPages, setTotalPages] = useState(1);
    useEffect(() => {
        const response = dispatch(getAllRoadContractsRepo({page, searchTerm})).unwrap().then((res) => {
    ...
    return (
        <div className="container h-screen flex justify justify-start flex-col mt-1 mx-auto px-1 overflow-auto ">
             <h1 className="text-[12px] font-bold">ROADS/SEA CONTRACTS REPOSITORY</h1>
            ...
            <div className="bg-white rounded-lg p-2 border shadow-md">
                ...
                <div className="max-h-[80vh] overflow-y-scroll">
                    ...
                    /> */}
                        ...
                        <tbody>
                            {roadcontractsRepository && roadcontractsRepository.length > 0 ? (
                                roadcontractsRepository?.map((item, itemIndex) => (
...
export default RoadContractsRepo;
